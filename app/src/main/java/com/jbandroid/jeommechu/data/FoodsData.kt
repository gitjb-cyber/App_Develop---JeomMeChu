...
object FoodsData {
    val foodsList: List<Food> = listOf(
        ...
        food("주먹밥", Tags.Korean, Tags.Rice, Tags.SoupNo, Tags.Cold, Tags.Mild, Tags.Seafood),
        ...
        food("사케동(회덮밥)", Tags.Japanese, Tags.Rice, Tags.SoupNo, Tags.Cold, Tags.Mild, Tags.Fish),
